...
void
draw_slide_buffer(sdl_slide_buffer_t self, SDL_FRect rect, float min_val, float max_val, SDL_FColor color)
{
...
void
copy_samples(float samples[], float other[], size_t size)
{
    for(size_t i = 0; i < size; i++)
    {
        samples[i] = other[i];
