...
constexpr double g_engine_radial_spacing = 2.2;
...
constexpr double g_engine_mic_position_ratio = 0.20;
...
/* accessory spec */
constexpr double g_engine_crankshaft_mass_kg = 12.3;
constexpr double g_engine_crankshaft_radius_m = 0.021;
constexpr double g_engine_flywheel_mass_kg = 7.15;
constexpr double g_engine_flywheel_radius_m = 0.27;
