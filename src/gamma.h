...
double g_cp_n2_j_per_mol_k[g_gamma_cp_precompute_buffer_size];
double g_cp_o2_j_per_mol_k[g_gamma_cp_precompute_buffer_size];
double g_cp_ar_j_per_mol_k[g_gamma_cp_precompute_buffer_size];
double g_cp_c8h18_j_per_mol_k[g_gamma_cp_precompute_buffer_size];
double g_cp_co2_j_per_mol_k[g_gamma_cp_precompute_buffer_size];
double g_cp_h2o_j_per_mol_k[g_gamma_cp_precompute_buffer_size];
