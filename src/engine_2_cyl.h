...
constexpr double g_engine_eplenum_wave_pipe_length_m = 0.9;
...
constexpr double g_engine_piston_0_theta_r = (0.00 / 4.0) * 4.0 * g_std_pi_r;
constexpr double g_engine_piston_1_theta_r = (1.00 / 4.0) * 4.0 * g_std_pi_r;
...
constexpr double g_engine_flywheel_mass_kg = 2.25;
constexpr double g_engine_flywheel_radius_m = 0.12;
