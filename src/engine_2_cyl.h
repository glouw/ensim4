static struct node_s g_node_2_cyl[] = {
    ...
    [3] = {
        ...
        .as.irunner = {
            ...
            .valve = {
                .engage_r = -0.0625 * g_std_four_pi_r + 0.25 * g_std_four_pi_r,
                .ramp_r = 0.25 * g_std_four_pi_r,
            },
        },
        .next = {7}
    ...
    [7] = {
        ...
        .as.piston = {
            ...
            .valve = {
                .engage_r = 0.7 * g_std_four_pi_r + 0.25 * g_std_four_pi_r,
                .ramp_r = 0.22 * g_std_four_pi_r + 0.25 * g_std_four_pi_r,
            },
            .sparkplug = {
                .engage_r = 0.55 * g_std_four_pi_r + 0.25 * g_std_four_pi_r,
                .on_r = 0.031 * g_std_four_pi_r + 0.25 * g_std_four_pi_r,
            },
            .diameter_m = 0.057,
            .theta_r = 0.25 * g_std_four_pi_r,
            .crank_throw_length_m = 0.031,
            .connecting_rod_length_m = 0.11,
            .connecting_rod_mass_kg = 0.4,
            .head_mass_density_kg_per_m3 = 7800.0,
