...
set multiplot layout 6,2
    ...
    plot "visualize/chamber_t_flow.txt" using 1:2 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_flow.txt" using 1:3 with lines linewidth 2 title "Chamber y"

    set ylabel "Speed of Sound (m/s)"
    plot "visualize/chamber_t_flow.txt" using 1:4 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_flow.txt" using 1:5 with lines linewidth 2 title "Chamber y"

    set ylabel "Mach"
    plot "visualize/chamber_t_flow.txt" using 1:6 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_flow.txt" using 1:7 with lines linewidth 2 title "Chamber y"

    set ylabel "Max Momentum (kg·m/s)"
    plot "visualize/chamber_t_flow.txt" using 1:8 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_flow.txt" using 1:9 with lines linewidth 2 title "Chamber y"

    set ylabel "Momentum (kg·m/s)"
    plot "visualize/chamber_t_flow.txt" using 1:10 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_flow.txt" using 1:11 with lines linewidth 2 title "Chamber y"
    ...
    set ylabel "Speed of Sound m/s"
    plot "visualize/chamber_t_flow.txt" using 1:23 with lines linewidth 2 title "Nozzle"
