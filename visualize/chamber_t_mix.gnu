...
set multiplot layout 6,2
    ...
    plot "visualize/chamber_t_mix.txt" using 1:2 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_mix.txt" using 1:3 with lines linewidth 2 title "Chamber y"

    set ylabel "Cv J/(mol·K)"
    plot "visualize/chamber_t_mix.txt" using 1:4 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_mix.txt" using 1:5 with lines linewidth 2 title "Chamber y"

    set ylabel "Cp J/K"
    plot "visualize/chamber_t_mix.txt" using 1:6 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_mix.txt" using 1:7 with lines linewidth 2 title "Chamber y"

    set ylabel "Cv J/K"
    plot "visualize/chamber_t_mix.txt" using 1:8 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_mix.txt" using 1:9 with lines linewidth 2 title "Chamber y"

    set ylabel "Moles"
    plot "visualize/chamber_t_mix.txt" using 1:10 with lines linewidth 2 title "Chamber x", \
         "visualize/chamber_t_mix.txt" using 1:11 with lines linewidth 2 title "Chamber y"
